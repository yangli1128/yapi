...
export default class Project extends Component {
    ...
    this.props.setBreadcrumb([
      {
        ...
        href: Directory+'/group/' + this.props.currGroup._id
      },
      {
  ...
  render() {
    ...
    let routers = {
      interface: { name: '接口', path: Directory+'/project/:id/interface/:action', component: Interface },
      activity: { name: '动态', path: Directory+'/project/:id/activity', component: Activity },
      data: { name: '数据管理', path: Directory+'/project/:id/data', component: ProjectData },
      members: { name: '成员管理', path: Directory+'/project/:id/members', component: ProjectMember },
      setting: { name: '设置', path: Directory+'/project/:id/setting', component: Setting }
    };
    ...
    Object.keys(routers).forEach(key => {
      ...
      if (key === 'interface') {
        value = {
          name: item.name,
          path: `${Directory}/project/${match.params.id}/interface/api`
        };
      } else {
        value = {
          name: item.name,
    ...
    return (
      <div>
        ...
        <Switch>
          <Redirect exact from={Directory+"/project/:id"} to={`${Directory}/project/${match.params.id}/interface/api`} />
